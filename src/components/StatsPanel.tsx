...
const StatsPanel: React.FC<StatsPanelProps> = ({
  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-4">
      <div className="backdrop-blur-md bg-black/30 rounded-lg sm:rounded-xl p-2 sm:p-4 text-center relative overflow-hidden border border-white/5 hover:border-blue-500/30 transition-all duration-300 group">
        ...
        <p className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2 relative z-10">Баланс GIFT</p>
      ...
      <div className="backdrop-blur-md bg-black/30 rounded-lg sm:rounded-xl p-2 sm:p-4 text-center relative overflow-hidden border border-white/5 hover:border-blue-500/30 transition-all duration-300 group">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition-all duration-300"></div>
        <p className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2 relative z-10">Всего NFT</p>
        <div className="flex items-center justify-center relative z-10">
          <p className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">
            {totalNFTs}
          </p>
          <svg className="w-4 h-4 sm:w-5 sm:h-5 ml-0.5 sm:ml-1 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="backdrop-blur-md bg-black/30 rounded-lg sm:rounded-xl p-2 sm:p-4 text-center relative overflow-hidden border border-white/5 hover:border-blue-500/30 transition-all duration-300 group">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition-all duration-300"></div>
        <p className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2 relative z-10">Фармится</p>
        <div className="flex items-center justify-center relative z-10">
          <p className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-emerald-400 to-teal-500 text-transparent bg-clip-text">
            {farmingNFTs}
          </p>
          <svg className="w-4 h-4 sm:w-5 sm:h-5 ml-0.5 sm:ml-1 text-emerald-400 animate-spin-slow" fill="currentColor" viewBox="0 0 20 20">
